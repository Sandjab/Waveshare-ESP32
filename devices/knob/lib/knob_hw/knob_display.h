...
// Initialize the ST77916 QSPI display and backlight.
//
// Usage:
//   esp_lcd_panel_handle_t panel = knob_display_init();                       // no callback (Basic_Blink)
//   esp_lcd_panel_handle_t panel = knob_display_init(flush_ready_cb, &ctx);   // with LVGL flush-ready
//
static inline esp_lcd_panel_handle_t knob_display_init(
