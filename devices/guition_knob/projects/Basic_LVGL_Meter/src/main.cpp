...
// Cadran lv_meter 0..100 pilote par l'encoder. Aiguille fluide, valeur
// affichee en gros au centre, arc qui se remplit en couleur progressive
// (bleu -> vert -> jaune -> rouge selon zone). Touche minimaliste mais
// 100% LVGL — sert de squelette pour toute UI a base de cadran circulaire.
...
void setup() {
    Serial.begin(115200);
    Serial.println("Guition JC3636K718 — Basic_LVGL_Meter");
