...
#define AUDIO_MUTE_PIN      GPIO_NUM_46   // 低电平静音


#define AUDIO_MIC_SD_PIN    GPIO_NUM_4
#define AUDIO_MIC_SCK_PIN   GPIO_NUM_5
...
#define QSPI_PIN_NUM_LCD_PCLK   GPIO_NUM_11
#define QSPI_PIN_NUM_LCD_CS     GPIO_NUM_12
#define QSPI_PIN_NUM_LCD_DATA0  GPIO_NUM_13
#define QSPI_PIN_NUM_LCD_DATA1  GPIO_NUM_14
#define QSPI_PIN_NUM_LCD_DATA2  GPIO_NUM_15
#define QSPI_PIN_NUM_LCD_DATA3  GPIO_NUM_16
#define QSPI_PIN_NUM_LCD_RST    GPIO_NUM_17
#define QSPI_PIN_NUM_LCD_BL     GPIO_NUM_21
#define QSPI_PIN_NUM_LCD_TE     GPIO_NUM_18

#define DISPLAY_OFFSET_X  0
#define DISPLAY_OFFSET_Y  0

#define TP_PORT             (I2C_NUM_1)
#define TP_PIN_NUM_TP_SDA   (GPIO_NUM_9)
#define TP_PIN_NUM_TP_SCL   (GPIO_NUM_10)
#define TP_PIN_NUM_TP_RST   (GPIO_NUM_8)
#define TP_PIN_NUM_TP_INT   (GPIO_NUM_7)
