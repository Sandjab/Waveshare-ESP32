...
static lv_indev_t *tp_indev = NULL;
...
void lcd_init()
{
    ...
    spi_bus_config_t buscfg = ST77916_PANEL_BUS_QSPI_CONFIG(PIN_LCD_SCL, PIN_LCD_D0,PIN_LCD_D1,PIN_LCD_D2,PIN_LCD_D3, 360 * 360 * 16 / 8);
    ...
    esp_lcd_new_panel_io_spi((esp_lcd_spi_bus_handle_t)LCD_HOST, &io_config, &disp_io_handle);
    ...
    esp_lcd_new_panel_st77916(disp_io_handle, &panel_config, &disp_panel_handle);
    esp_lcd_panel_reset(disp_panel_handle);
    esp_lcd_panel_init(disp_panel_handle);
    esp_lcd_panel_mirror(disp_panel_handle,true,true);
    esp_lcd_panel_disp_on_off(disp_panel_handle, true);
    ...
    esp_lcd_touch_config_t tp_cfg = {
        .x_max = LCD_H_RES,
        .y_max = LCD_V_RES,
        .rst_gpio_num = PIN_TP_RST, // Shared with LCD reset
    ...
    // esp_lv_adapter_display_config_t display_cfg = ESP_LV_ADAPTER_DISPLAY_SPI_WITH_PSRAM_TE_DEFAULT_CONFIG(
    //                                                   disp_panel_handle, disp_io_handle,
    //                                                   LCD_H_RES, LCD_V_RES, ESP_LV_ADAPTER_ROTATE_0, GPIO_NUM_18,50 *1000 * 1000,4,16);

    esp_lv_adapter_display_config_t display_cfg = ESP_LV_ADAPTER_DISPLAY_SPI_WITH_PSRAM_DEFAULT_CONFIG(
                                                      disp_panel_handle, disp_io_handle,
                                                      LCD_H_RES, LCD_V_RES, ESP_LV_ADAPTER_ROTATE_0);
    // display_cfg.te_sync.gpio_num =  18;                                  
    disp = esp_lv_adapter_register_display(&display_cfg);
    ...
    // const knob_config_t hw_knob_encoder_config = {
    //     .default_direction = 0,
    ...
    //     .disp = disp,
    //     .encoder_a_b =  &hw_knob_encoder_config,
    //     .encoder_enter = NULL,
    // };
