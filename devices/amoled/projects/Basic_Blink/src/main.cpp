...
// --- RGB565 byte-swapped colors (big-endian for the SH8601 driver) ---
...
void setup() {
    Serial.begin(115200);
    Serial.println("Waveshare ESP32-S3-Touch-AMOLED-1.8 — Basic_Blink");

    panel_handle = amoled_display_init();
